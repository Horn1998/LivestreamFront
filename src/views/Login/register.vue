        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              ...
              <li>
                <div class="input">
                  <input type="text" v-model="registered.userSex" placeholder="性别">
                </div>
              </li>
              <li>
                <div class="input">
                  <input type="email"
                         id="email" v-model="registered.userEmail" placeholder="email">
                </div>
              </li>
              <li>
                <div class="input">
                  <input type="text"
                         v-model="registered.userAddress" placeholder="电话">
                </div>
              </li>
            </ul>
            ...
            <div>
              <y-button text="返回" @btnClick="toLogin"
                style="width: 100%;height: 48px;font-size: 18px;line-height: 48px">
              </y-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    regist () {
      ...
      let sex = this.registered.userSex
      let email = this.registered.userEmail
      let address = this.registered.userAddress
      ...
      if (emailReg.test(emailV) || emailV == '') {              
      } else {this.message('邮箱格式不对!'); this.registxt = '注册'; return false;}

      register({
        loginName: userName,
        userName: userName,
        password:Encrypt(userPwd),
        sex:sex,
        email:email,
        address:address,
