        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            ...
            <li style="text-align: right" class="pr">
              ...
              <a href="javascript:;" class="register" @click="toRegister">注册 emall 账号</a>
          ...
          <!--返回-->
          <div>
            <y-button text="注册" @btnClick="toRegister"
  ...
  methods: {
    ...
    login () {
      ...
      var params = {
        ...
        passWord: Encrypt(this.ruleForm.userPwd),
      }
