<template>
  <div class="header-box">
    <div>
        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="EMall商城官网">EMall商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              ...
              <el-button @click="downloadFile()" style="width:100px; height:40px;margin-left:20px">文件下载</el-button>
      ...
      <slot name="nav">
        <div class="nav-sub" style="height:40px">
